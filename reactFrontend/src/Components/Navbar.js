...
const Navbar = () => {
  ...
  const organization_login = () => {
    history.push("/login");
  };
  const student_signup = () => {
    history.push("/student-sign-up");
  };
  const organization_signup = () => {
          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Button
                id="Login"
                variant="outlined"
                style={{ color: "#6062ff", marginRight: "1rem" }}
              ...
              >
                ...
                <MenuItem onClick={organization_login}>
                  Organization Login
                </MenuItem>
              </Menu>
              <Button
              ...
              >
                ...
                <MenuItem onClick={organization_signup}>
                  Organization Signup
                </MenuItem>
              </Menu>
            </Box>
