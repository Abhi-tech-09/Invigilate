...
export default function Student_Dashboard() {
  ...
  const registerStudents = () => {
    ...
    if (students == "None") {
      ...
      for (let i = 0; i < studentArr.length; i++) {
        ...
        if (i < studentArr.length - 1) students += ",";
      }
      var ciphertext = CryptoJS.AES.encrypt(
        students,
        "my-secret-key@123"
  ...
  const start = () => {
    var test_details = firebase
      .database()
      .ref("Students/" + currentUser.uid + "/Tests/" + examdetails.test_key);
          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Logout">
                <Button
                  variant="contained"
                  style={{ backgroundColor: "#6062ff", margin: "10%" }}
                  onClick={leave}
                >
                  Logout
                </Button>
      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2}>
          <Grid item xs={6}>
            ...
            <img
              src={photo}
              style={{ height: "60%", borderRadius: "5%", marginLeft: "4%" }}
            />
          </Grid>
          <Grid item xs={6}>
            <br />
            ...
            {!examdetails && (
              <Card sx={{ maxWidth: 500 }} style={{ padding: "1.5rem" }}>
                ...
                <Button
                  variant="contained"
                  style={{ backgroundColor: "#6062ff", margin: "2%" }}
                  onClick={direct}
                >
                  Submit
                </Button>
                ...
                >
                  ...
                  >
                    ...
                    <b style={{ color: "#ffbf00" }}>
                      {examdetails.test_duration} minutes
                    </b>
                    .
                  </Typography>
                  <Button
                    variant="contained"
                    style={{ backgroundColor: "#6062ff", margin: "1%" }}
                    onClick={notifyMe}
                  >
                    Notify Me
                  </Button>
                  ...
                  <br />
                  2. No cell phones or other secondary devices in the room or
                  test area
                  <br />
                  3. Your desk/table must be clear or any materials except your
                  test-taking device
                  <br />
                  ...
                  5. No talking
                  <br />
                  6. The testing room must be well-lit and you must be clearly
                  visible
                  <br />
